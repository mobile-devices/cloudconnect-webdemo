...
{
    public class NotificationProvider : RepositoryBase<Notification>
    {
        ...
        public IEnumerable<Notification> RequestNotificationCache(string key, DateTime max_date)
        {
            IEnumerable<Notification> result = GetAllByDropped("false", "false", 1000);
